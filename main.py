...
class App:
    ...
    def process_webcam(self):
        ...
        self.most_recent_capture_arr_pill = Image.fromarray(img_)

        imgtk = ImageTk.PhotoImage(image=self.most_recent_capture_arr_pill)

        self._label.imgtk = imgtk
        self._label.configure(image=imgtk)

        self._label.after(20, self.process_webcam)  # after 20ms gona redo the process
